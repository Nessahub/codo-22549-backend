...
public class Persona {
	...
	//alt+shit+s setters y getters permiten modificar los atributos de una clase
	// para debug F5 para meterse, F6 para saltar la linea. F8 para terminar ejecuta las lineas q siguen hasta un prox debug
}
